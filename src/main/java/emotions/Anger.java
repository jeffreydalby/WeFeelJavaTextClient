...
public class Anger extends CoreEmotion implements Serializable {

    //description to help people translate a core Emotion into the more broad spectrum of emotions.
    private static String angerDescription = "Irritability, Bitter, Aggravation, Agitation, Annoyance, Exasperation, Frustration, Rage, Fury, Wrath, Resentment, Hatred";

    public Anger(){
        this(0);
    }
    @JsonCreator
    public Anger(@JsonProperty("intensity") double intensity){
        super(emotionNames.Anger,angerDescription);
